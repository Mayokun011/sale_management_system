package com.amexcode.salemanagementsystem.customer.controller;
...
import com.amexcode.salemanagementsystem.products.service.*;
...
public class OrderController {
    ...
    public String removeOrder(Long id, RedirectAttributes attributes) {
